...
var style_IndicedeVegetacin_4 = function(feature, resolution){
    ...
    if (value >= 0.222007 && value <= 0.295435) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.295435 && value <= 0.368864) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.368864 && value <= 0.442292) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.442292 && value <= 0.515720) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.515720 && value <= 0.589149) {
            style = [ new ol.style.Style({
