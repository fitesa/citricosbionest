...
var style_EvolucinIndicedeHumedad_1 = function(feature, resolution){
    ...
    if (value >= -0.164005 && value <= -0.121109) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.121109 && value <= -0.078213) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.078213 && value <= -0.035316) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.035316 && value <= 0.007580) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.007580 && value <= 0.050476) {
            style = [ new ol.style.Style({
