...
var style_IndicedeHumedad_2 = function(feature, resolution){
    ...
    if (value >= -0.148906 && value <= -0.100906) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.100906 && value <= -0.052906) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.052906 && value <= -0.004906) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.004906 && value <= 0.043094) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.043094 && value <= 0.091094) {
            style = [ new ol.style.Style({
